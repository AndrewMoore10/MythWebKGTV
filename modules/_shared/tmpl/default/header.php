...
// Globals
    ...
    $headers[] = '<script type="text/javascript" src="'.root_url.'js/detectBrowser.js"></script>';
...
?>
    <script type="text/javascript">
        ...
        var bannerClose = "<img class=\"exit\" src=\"<?php echo skin_url ?>img/close.png\" onclick=\"bannerCloseAndClear()\"/>";
        $j(document).ready(function() {
            $j("#alertBanner").append(bannerClose);
            if((BrowserDetect.browser == "Explorer" && BrowserDetect.version < 9) ||
                (BrowserDetect.browser == "Firefox" && BrowserDetect.version < 21) ||  
                (BrowserDetect.browser == "Firefox") || // Some 32bit firefox builds do no support the m4v video format and will not play in browser video
                (BrowserDetect.browser == "Safari" && BrowserDetect.version < 5.1) ||
                false) {
                    $j("#alertBanner").append("You are currently using '"+BrowserDetect.browser + 
                        " " + BrowserDetect.version +
                        "'. This browser is not fully compatible with MythTV. Please download <b><a href='https://www.google.com/intl/en/chrome/browser/'>Chrome</a></b>, update your browser or use a different one.");
//                    $("alertBanner").style.display = "block";
                    $j("#alertBanner").slideDown();
            }

        });
        function bannerAlert ( content ){
            $j("#alertBanner").append( "<br/>"+content );
            $j("#alertBanner").slideDown();
        }
        
        function bannerCloseAndClear (){
            $j('#alertBanner').slideUp( 400, function(){
                $j('#alertBanner').html(bannerClose);
            })
...
?>
        ...
        <a id="help_link" href="/MythTV Help.pdf" >
            <span style="display: none;"><?php echo 'Help'; ?></span>
        </a>
    </div>
    <div id="extra_header">
        <div id="help_wrapper">
        ...
        <tr>
            <td><div id="command_choices">
                    ...
                    <?php if (Modules::getModule('tv')) { ?>
                        ...
                        &nbsp; | &nbsp;
                        <a href="tv/quad"><?php echo t('Quad View') ?></a>
                        &nbsp; | &nbsp;
                        <?php if (!$mobile) { ?>
                        <a href="tv/live">LiveView</a>
                        &nbsp; | &nbsp;
                        <?php } ?>
                    <?php } ?>
